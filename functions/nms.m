% Important: note that the procedure, taken from the code of Girshick, has
% been modified. Now it takes as input "boxes", where (for coherence with
% other BB representations):
...
% boxes(:,5) contain the classification scores
